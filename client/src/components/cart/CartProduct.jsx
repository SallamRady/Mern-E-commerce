...
const CartProduct = ({ id, name, image, category, qty, total, price }) => {
  ...
  return (
    <div className="bg-slate-200 p-2 flex gap-4 rounded border border-slate-300 mb-1">
      ...
      <div className="flex flex-col gap-1 w-full">
        ...
        <div className="flex justify-between ">
          <div className="flex gap-3 items-center">
            <button
              onClick={() =>
                dispatch(addToCart({ id, name, image, category, price }))
              }
            ...
            <button
              onClick={() => dispatch(decreaseItemFromCart(id))}
              className="bg-slate-300 py-1 mt-2 rounded hover:bg-slate-400 p-1 "
            >
              <TbMinus />
            </button>
